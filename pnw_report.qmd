...
\textbf{Riparian corridor: `r ifelse(params$anc_rip == TRUE,'Yes','')`}

\textbf{Erosion and deposition: `r ifelse(params$anc_erosion == TRUE,'Yes','')`}

\textbf{Floodplain connectivity: `r ifelse(params$anc_fp == TRUE,'Yes','')`}
