...
subtitle: "SDAM Version 2.0.1 Release Date: February 2025"
revision: "SDAM revision date: February, 2025" 
  ...
  pdf:
    include-in-header:
      - text: |
          ...
          \cfoot{}
          \lfoot{SDAM Version 2.0.1 February 2025, Date of site visit: \sitedate}
    template-partials:
      - before-body.tex
params:
    stream_class: NA
...
\begin{tcolorbox}
    ...
    \vspace{2mm}
    \begin{center}
        \begin{Large} SDAM Version 2.0.1 Release Date: February 2025 \end{Large}
    \end{center}
    \vspace{2mm}
    \begin{center}
