...
subtitle: "SDAM Version 3.0.1 Release Date: September 2025"
revision: "SDAM revision date: September, 2025" 
  ...
  pdf:
    include-in-header:
      - text: |
          ...
          \cfoot{}
          \lfoot{SDAM Version 3.0.1 September 2025, Date of site visit: \sitedate}
    template-partials:
      - before-body.tex
params:
    stream_class: NA
...
\begin{tcolorbox}
    \begin{center}
        \begin{huge} Streamflow Duration Assessment Method Report \end{huge}
    \end{center}
    \vspace{2mm}
    \begin{center}
        \begin{Large} SDAM Version 3.0.1 Release Date: September 2025 \end{Large}
    \end{center}
    \vspace{2mm}
    \begin{center}
    ...
    \vspace{2mm}
    \begin{center}
        \begin{large}`r params$region` SDAM classification: `r params$stream_class`\end{large}
    \end{center}
...
if (params$h != 'Not Provided'){
  lmap <- leaflet(options=leafletOptions(minZoom=16, maxZoom=16)) %>%
    addTiles(urlTemplate = "https://basemap.nationalmap.gov/arcgis/rest/services/USGSTopo/MapServer/tile/{z}/{y}/{x}") %>%
    addCircleMarkers(
        lng=params$h,
        lat=params$g,
        weight=10,
...
Location: `r ifelse(params$g != 'Not Provided' | params$h != 'Not Provided', paste0(params$g,", ", params$h), paste0('Not provided'))`
...
Assessment reach length (m): `r ifelse(params$fff == 'NA', '', params$fff)`
...
\textbf{Aquatic macroinvertebrates: `r if (!is.null(params$aqua_inv)) {params$aqua_inv}`}

Notes about aquatic macroinvertebrates:
...
Notes about hydrophytic vegetation:
...
\textbf{Presence/absence of upland rooted plants in streambed: `r if (!is.null(params$upland_rooted)){params$upland_rooted}`}
...
\textbf{Presence of sediment on plants or debris: `r if (!is.null(params$sediment)){params$sediment}`}
...
Sediment photos and descriptions: 
...
\begin{tcolorbox}[colframe=darker-blue,
  colback=my-blue,
  width=16cm,
  title={\centering \Huge \underline{\textcolor{white}{`r params$region` SDAM classification}}},
  fonttitle=\bfseries,
  coltitle=white]
  \begin{center}
