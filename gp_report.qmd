...
subtitle: "SDAM Version 3.0.1 Release Date: October 2025"
revision: "SDAM revision date: October, 2025" 
  ...
  pdf:
    include-in-header:
      - text: |
          ...
          \cfoot{}
          \lfoot{SDAM Version 3.0.1 October 2025, Date of site visit: \sitedate}
    template-partials:
      - before-body.tex
params:
    stream_class: NA
...
\begin{tcolorbox}
    ...
    \vspace{2mm}
    \begin{center}
        \begin{Large} SDAM Version 3.0.1 Release Date: October 2025 \end{Large}
    \end{center}
    \vspace{2mm}
    \begin{center}
