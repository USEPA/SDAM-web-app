...
\textbf{Mean watershed elevation from }
\href{https://www.epa.gov/national-aquatic-resource-surveys/streamcat-web-tool-map-view/}{\textcolor{cyan}{StreamCat}}
\textbf{(in feet): `r if (!is.null(params$elevation)){params$elevation}`}



Notes about mean watershed elevation from StreamCat:

`r params$notes_elevation`
