...
\textbf{Average Entrenchment Ratio: `r if (!is.null(params$entrenchment)){params$entrenchment}`}


Notes about average Entrenchment Ratio:

`r params$notes_entrenchment`


Entrenchment photos and descriptions:
...
if (!length(params$f59)==0){ 
  knitr::include_graphics(params[["f59"]])
}
...
if (!length(params$f60)==0){ 
  knitr::include_graphics(params[["f60"]])
} 
...
if (!length(params$f61)==0){ 
  knitr::include_graphics(params[["f61"]])
}
