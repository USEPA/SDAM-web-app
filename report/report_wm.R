        ...
        column(10,
            ...
            div(
                ...
                h2(
                    ...
                    HTML('<b><u>Western Mountains SDAM Report</u></b>')
                ),
                ...
                div(
                    ...
                    textAreaInput(
                        inputId = "notes_riff", 
                        label = "Notes about riffle-pool sequence:", 
                        value = "", 
                        width = '100%',
                        height = '75px',
                        placeholder = NULL
                ...
                div(
                    h4(HTML("<b><u>Particle size or stream substrate sorting</u></b>")
                    ) %>% tagAppendAttributes(class = 'center-div-text'),
